...
export function Contact() {
  return (
    <section
      id="contact"
      className="bg-gradient-to-b from-zinc-50 to-zinc-100 px-6 py-24 dark:from-zinc-900 dark:to-zinc-950"
    >
      <div className="mx-auto max-w-xl">
        <FadeIn>
          <h2 className="bg-gradient-to-r from-zinc-900 to-zinc-600 bg-clip-text text-center text-3xl font-bold tracking-tight text-transparent dark:from-white dark:to-zinc-400">
            Get In Touch
          </h2>
        </FadeIn>
        <FadeIn delay={0.1}>
        ...
        {/* Form outside of FadeIn to avoid motion interference */}
        <form
          name="contact"
          method="POST"
          action="/success"
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-8">
          <motion.a
            ...
            className="flex items-center gap-2 text-zinc-500 transition-colors hover:text-purple-600 dark:text-zinc-400 dark:hover:text-purple-400"
            whileHover={{ y: -2 }}
          >
